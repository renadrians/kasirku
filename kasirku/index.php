                ...
                <div class="card-body py-4">
                    <form method="POST">
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-sm-8 mb-2">
                                <input type="number" class="form-control form-control-sm" id="stok" name="stok" readonly>
                            </div>
                            ...
                            <div class="col-sm-8 offset-sm-4 mt-2">
                                <button class="btn btn-warning btn-sm" name="save" value="simpan" type="submit">
                                    <i class="fa fa-shopping-cart mr-2"></i>Keranjang</button>
                            </div>
                        </div> 
                    </form>
                    <?php
                    if(isset($_POST['save'])){
                        ...
                        $query_stok = mysqli_query($conn, "SELECT stok FROM barang WHERE id_barang = '$kode_barang'");
                        $data_stok = mysqli_fetch_assoc($query_stok);
                        $stok_sekarang = $data_stok['stok'];
                        $stok_terbaru = $stok_sekarang - $quantity;

                        $update_stok = mysqli_query($conn, "UPDATE barang SET stok = '$stok_terbaru' WHERE id_barang = '$kode_barang'");
                        if (!$update_stok) {
...
$kodeCart = $huruf . $tgl;
            ...
            <form method="POST">
                ...
                <i class="fa fa-coins mr-2"></i>Bayar</button> 
                </div>
            </form>
            <?php
        ...
        echo "$notransaksi";
          ...
          <hr class="mt-0">
              ...
              <div class="col-5 pr-0">
                  ...
                  <i class="fa fa-shopping-basket fa-xs text-danger mr-1"></i>
...
if(isset($_POST['selesai'])) {
    $ambildata = mysqli_query($conn, "INSERT INTO laporanku (no_transaksi, bayar, kembalian, kode_barang, nama_barang, harga_barang, quantity, subtotal, tgl_input)
        SELECT no_transaksi, bayar, kembalian, kode_barang, nama_barang, harga_barang, quantity, subtotal, tgl_input
...
?>
  ...
  <script type="text/javascript">
    ...
    function changeValue(id_barang) {
        ...
        document.getElementById("stok").value = stok[id_barang].stok; // Set nilai stok
    };
